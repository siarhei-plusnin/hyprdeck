...
namespace hyprdeck {
    ...
    inline constexpr int    DEFAULT_MINIMUM_NUMBERED_WORKSPACES    = 3;
    inline constexpr int    DEFAULT_NUMBERED_WORKSPACES_AFTER_LAST = 1;
    inline constexpr int    MAX_CONFIGURED_NUMBERED_WORKSPACES     = 100;
